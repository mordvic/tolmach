...
| The toolbar with its three labels and **no** «Толмач» in the middle | The half of this that a screenshot already settled: the labels were missing and the title was interleaved. What it does not settle is the result — whether «Из», «В» and «Тон» plus three pop-ups plus ⇄ plus «Перевести» still fit at the 700 pt minimum width, and what macOS does with the group when they do not. The drawing only ever shows this row at 900 | `MainWindowView.swift` |
