...
| **The перевод pane's header at the pane's 280 pt floor** | Measured 2026-09-04 (`Scripts/pane-header-fit.swift`): three segments want 495 pt, today's two 397, a `.menu` 352 — none fits 280, and the two-segment header shipped that way before the third arrived. Either the floor is wrong or the header is; a screen has to say which is worse at 280 | `TranslationPane` (`.frame(minWidth: 280)`), `PaneViewChoice` |
