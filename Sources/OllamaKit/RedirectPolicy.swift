// Sources/OllamaKit/RedirectPolicy.swift
import Foundation
...
/// `127.0.0.1:11434` while Ollama is down can answer every request with
...
///
/// Duplicated in `LMStudioKit`, for the reason `BoundedLines` is: the two transport modules do
